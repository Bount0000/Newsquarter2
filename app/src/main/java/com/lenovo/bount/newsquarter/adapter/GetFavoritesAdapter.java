...
public class GetFavoritesAdapter extends RecyclerView.Adapter<GetFavoritesAdapter.MyHolder> implements View.OnClickListener,DianzanView,CommentView,AddFavoriteView,RemoveFavoriteView
{
    private int a=0;
    ...
    private  List<GetFavoritesBean.DataBean>  dataBeanList;
    private View view3;
    ...
    public GetFavoritesAdapter(Context context, List<GetFavoritesBean.DataBean>  dataBeanList) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=View.inflate(context, R.layout.shouchang_item,null);
    ...
    public void onBindViewHolder(final MyHolder holder, final int position) {
        ...
        checkBoxInterface.CheckBox(holder.cb);
             ...
             AlertDialog.Builder builder=new AlertDialog.Builder(context);
                 ...
                 builder.setPositiveButton("确定",new DialogInterface.OnClickListener() {
                     ...
                     public void onClick(DialogInterface dialogInterface, int i) {
                         removeFavoritePresenter.RomoveFavorite(MyInterceptor.uid,"223");
