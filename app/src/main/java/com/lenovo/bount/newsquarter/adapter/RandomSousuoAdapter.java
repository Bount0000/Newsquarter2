...
public class RandomSousuoAdapter extends RecyclerView.Adapter<RandomSousuoAdapter.MyHolder2> {
private Context context;
   private List<RandomFriendsBean.DataBean> data;

    public RandomSousuoAdapter(Context context, List<RandomFriendsBean.DataBean> data) {
